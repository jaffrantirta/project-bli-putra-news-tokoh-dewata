    ...
    <div>
      ...
      <div className="p-10 grid grid-cols-1 md:grid-cols-4 gap-10">
        <div className="md:col-span-3">
          <p className="font-bold text-xl md:text-4xl xl:text-6xl">
            {newsDetail.title}
          </p>
          ...
          <div className="hidden md:grid grid-cols-1 md:grid-cols-3 gap-5">
            <button
              onClick={() => shareOnFacebook(newsDetail.id, newsDetail.title)}
              className="bg-blue-900 text-white p-3 font-bold"
            >
              FACEBOOK
            </button>
            <button
              onClick={() => shareOnTwitter(newsDetail.id, newsDetail.title)}
              className="bg-sky-400 text-white p-3 font-bold"
            >
              TWITTER
            </button>
            <button
              onClick={() => sharedOnWhatsApp(newsDetail.id, newsDetail.title)}
              className="bg-green-500 text-white p-3 font-bold"
            >
              WHATSAPP
            </button>
          </div>
